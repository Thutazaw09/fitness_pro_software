    ...
    public class LoginUser
    {
        ...
        public static void RegisterUser(string username, string password)
        {
            using (SQLiteConnection connection = DBHelper.GetConnection())
            {
                ...
                using (SQLiteCommand getLastUserIDCmd = new(getLastUserIDQuery, connection))
                {
                    ...
                    using (SQLiteCommand insertUserCmd = new(insertUserQuery, connection))
                    {
                    ...
                    using (SQLiteCommand insertUserDatacmd = new(insertUserDataQuery, connection))
                    {
